...
{
    //Extensions Methodos: Quando você cria um método no caso DebitarContaInvestimento, mas, ela se comporta como se fosse uma classe da this DebitoConta.
    //Para criar um extensions methods: Primeiro a classe precisa ser static e o método também, pois na hora
    //de compilar, o compilador vai entender que essa classe não tem um estado, e ela irá trabalhar dentro da classe DebitarContaInvestimento,
